...
$\notFOmodels$ $\notcongr{\+R}$ $A \nothomregto B$}
	...
	\item \todo{check that proof sketch/proof don't overlap}
	\item O -> \backslash+O
\end{itemize}

Last:
\begin{itemize}
	\item check no page number / header on contents \& new part page.
	\item margins properly displayed
	\item contents properly displayed (line too long, cf contents of ch V)
\end{itemize}