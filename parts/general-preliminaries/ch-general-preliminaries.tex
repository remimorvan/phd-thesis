...
for a formal definitions.
Some problems in "XP" belong to "FPT", and are considered to be tractable,
"ie" efficiently solvable in practical. On the other hand, others problems,
such as the $k$-clique problem, when parameterized by $k$,
are in "XP" but are "W1"-hard, and hence conjectured not be in "FPT".
