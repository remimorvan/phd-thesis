...
Said otherwise, when going from FO over the structure $\univStructSynchronous{\Sigma}$ to MSO over the structure of a finite word, we gain one level of quantification "via" the logic, but we lose
one level of quantification "via" the change of model.
