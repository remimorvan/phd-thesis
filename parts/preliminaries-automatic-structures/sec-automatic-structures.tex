...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\node[below left=of eps] (a) {};
		\node[below right=of eps] (b) {};
		\node[below left=of a] (aa) {};
		\node[below right=of a] (ab) {};
		\node[below left=of b] (ba) {};
		\node[below right=of b] (bb) {};
		...
		\node[below right=-.25em of eps, font=\tiny, color=cDarkGrey] {$\varepsilon$};
		\node[below right=-.25em of a, font=\tiny, color=cDarkGrey] {$a$};
		\node[below right=-.25em of b, font=\tiny, color=cDarkGrey] {$b$};
		\node[below right=-.25em of aa, font=\tiny, color=cDarkGrey] {$aa$};
		\node[below right=-.25em of ab, font=\tiny, color=cDarkGrey] {$ab$};
		\node[below right=-.25em of ba, font=\tiny, color=cDarkGrey] {$ba$};
		\node[below right=-.25em of bb, font=\tiny, color=cDarkGrey] {$bb$};
	\end{tikzpicture}
	\caption{
...
\begin{itemize}
	\item $\tup{\N, \textrm{succ}}$ has a decidable "weak monadic second-order logic",
		...
		for studying automata, see \todo{addref-prelims}.}
