...
\begin{marginfigure}
	...
	\begin{tikzpicture}
		...
		\node[right=-.25em of a, font=\tiny, color=cDarkGrey] {$a$};
		\node[right=-.25em of b, font=\tiny, color=cDarkGrey] {$b$};
		\node[right=-.25em of aa, font=\tiny, color=cDarkGrey] {$aa$};
		\node[right=-.25em of ab, font=\tiny, color=cDarkGrey] {$ab$};
		\node[right=-.25em of ba, font=\tiny, color=cDarkGrey] {$ba$};
		\node[right=-.25em of bb, font=\tiny, color=cDarkGrey] {$bb$};
	\end{tikzpicture}
	\caption{
