...
Over, when going to "$\omega$-tree-automaticity", not only is the "isomorphism problem"
undecidable: Finkel and Todor\v{c}ević exhibited two somewhat simple-looking
...
todo: add \cite{KuskeLohrey2010AutomaticGraphs}.
