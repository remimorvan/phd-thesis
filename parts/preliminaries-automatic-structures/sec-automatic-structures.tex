...
\begin{proof}
	...
	\]
	this is simply done by transforming the tuple $\tup{u^1, \dotsc, u^d}$
...
"order-invariant" or "$\omega$-order-invariant", be it on "finite structures"
...
"order-invariant" (resp. "$\omega$-order-invariant").}
...
can show that whether the graph contains an infinite "clique" (or "tournament")
