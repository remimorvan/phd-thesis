...
if it is "recognized@@desync" by a "multitape automaton",
...
and hence, it is also not closed complementation.\footnote{Indeed, closure under uni
on and complementation implies closure under intersection, using De Morgan's law.}

Say that a "monoid morphism" $f\colon \Gamma^* \to \Sigma^*$ is \AP""length-multiplying""
