...
decade. They admit several characterizations TODO.
For instance, the intersection of "functional relations" and "two-way rational relations"
collapses to "regular functions" \cite[Theorem 22, p.~243]{EH2001transduction}.
...
By construction, "regular functions" all have a linear growth todo:addref.%
\footnote{Meaning that if $\pair{u,v}$ belongs to the relation, then $|v| \leq k\cdot |u|$ for some constant $k$.}
This model has been generalized to ``polyregular
functions''---which have polynomial growth---by todo.
However, whether the equivalence problem is decidable for this class is still open.
