...
consisting of all triples $\tup{u,v,w}$ "iff" $uv = w$, where $u,v,w\in\Sigma^*$.
...
\begin{proposition}
	...
	An "ExpTime" upper bound was claimed in \cite[Table~1]{CartonChoffrutGrigorieff2006DecisionProblems},
	and proved wrong in \cite[\S~4.1]{LodingSpinrath2019DecisionProblems}.
	The "ExpTime" upper bound for binary relations was proven
	in \cite[Corollary~22]{LodingSpinrath2019DecisionProblems}.}
	The ""$\REC$-membership problem for automatic relations"" is "2ExpTime".
	Moreover, it works in "ExpTime" for binary relations.
\end{proposition}
