...
Despite multiple reviews, the mistake was never spotted by anyone. TODO: IS IT?}
For instance, we will see in todo:addref see that "deterministic two-way multitape automata"
...
The book does not even mention two-way models.}
...
Clearly, \Cref{fig:multitape-automaton-suffix} is not "deterministic@@desync". But in fact, we prove a stronger result: $\suffix$ is not "deterministic rational@@rel".
TODO.

todo:intersection non-emptiness undecidable \cite[\S~12]{RabinScott1959FiniteAutomata}.
...
TODO: \url{https://arxiv.org/pdf/1205.0178} says that the model is not closed under complementation…
...
Since intersection non-emptiness of "deterministic rational relations" is undecidable,
...
are closed under union and intersecton. todo.
