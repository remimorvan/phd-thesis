...
appropriate references for "synchronous@@rel" and "rational relations".
...
if it is "recognized@@desync" by an "multitape automaton",
...
% 		An "multitape automaton" for the "local squaring function"
% 		when $\Sigma = \{a,b\}$.
% 	}
% \end{marginfigure}
\begin{marginfigure}[-10em]
	...
	\caption{
		...
		An "multitape automaton" for the "subword relation" $\subword$
		when $\Sigma = \{a,b\}$.
	}
\end{marginfigure}
\begin{marginfigure}
	...
	\caption{
		...
		An "multitape automaton" for the "suffix relation" $\suffix$.
	}
\end{marginfigure}
...
\begin{proof}[Proof sketch]
	...
	as a classical automaton. However, when seen as a "multitape automaton", some determinism 
