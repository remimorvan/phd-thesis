...
and "deterministic two-way transducers" enjoy very different properties.

Hence, the goal of this section is to provide an overview of these classes of relations/transductions, explain how they relate to one another, and give pointers to suitable references.
...
\begin{marginfigure}
	...
	\caption{
		...
		A ``two-way multitape automaton'' for the relation $\set{\tup{u, u\cdot u^r} \mid u\in\Sigma^*}$ where $u^r$ denotes the reverse of $u$.
...
It also makes sense to look at their models: informally, in a given state, we
...
\subsection{Let's Not Forget About Transducers}
...
"Regular functions" all have a linear growth.%
...
"regular functions" and related membership problems.
