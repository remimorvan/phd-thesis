...
It is also closed under concatenation, Kleene closure and reversal \cite[Table~1]{FischerRosenberg1968Multitape}.
...
intersection, concatenation, Kleene closure nor reversal
...
of "rational relations". In fact, this model is closed under Boolean operations,
and so since "rational relations" are not, it follows that
...
\footnote{This elegant proof comes from \cite[\S~12]{RabinScott1959FiniteAutomata}.}
...
are closed under union and intersecton.
\todo{ complement.}
...
\subsection{Transducers Are Equivalent to Multitape Automata Except When They Are Not}
...
there are "function relations" that can be recognized by
...
\footnote{This can be shown formally by using \cite[Theorem~V.4.2]{Sakarovitch2009Elements}
...
We refer the reader to Douéneau's Ph.D. thesis \cite[\S~1]{Douéneau2023PhD} for variations on
"transducers" models and related "membership problems".
