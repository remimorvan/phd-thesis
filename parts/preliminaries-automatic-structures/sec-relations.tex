...
linearly ordered than expected, as depicted in \todo{addref}.
...
\todo{Mention that if class is effectively closed under union, then inclusion reduces
to functionality.}
\todo{Add closure under composition for the different hierarchies.}
