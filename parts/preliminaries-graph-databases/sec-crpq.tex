...
\begin{proposition}[{\cite[Lemma 8]{Figueira2020Containment}}]
	\AP\label{prop:variation-figueira-simple}
...
and so the problem of \Cref{prop:variation-figueira-simple}
can be reformulated as
\[
    K \subseteq^? \A^* \big( \bigcap_{i=1}^p L_i \big) \A^*.
\]
The proof of \Cref{prop:variation-figueira-simple} is by reduction
