...
\begin{chapterpresentation}
	...
	\begin{acknowledgements}
		This chapter is mostly a reproduction of the eponymous paper that was published in PODS '25 \todo{ref}, which received the \emph{Distinguished Paper Award}.
		\todo{explain modifications :
			Preliminaries removed (moved to \Cref{ch:prelim-graph-databases})
			+ proof incorporated in body}
