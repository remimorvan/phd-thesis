...
One simple (and tractable) way to make a query smaller is to `contract' any two consecutive atoms sharing an "internal variable", and replacing them with
a single atom having the concatenation of the languages.
