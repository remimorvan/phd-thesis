...
proven by Czerwiński, Martens, Niewerth \& Parys \cite[Theorem 3.1]{min-tree-patterns}.
\todo{``We leave the details for a future long version of this article.''}

A \AP""tree pattern""---see "eg" \cite[\S 2.2]{min-tree-patterns}---over node variables
...
\begin{proposition}
	...
	\begin{itemize}
		\item $\tau_1 \contained \tau_2$ as "tree patterns"---in the sense of
			\cite[Definition 2.2]{min-tree-patterns}, and
