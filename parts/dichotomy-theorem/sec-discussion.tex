...
\begin{proof}[Proof of \Cref{prop:automatic-graph-not-fin-colourable}]
  ...
  $\bigdcup_{n\in\N} \Myc^n(H)$ \textcolor{red}{DIEGO: THIS IS NOT TRUE BECAUSE OF RECURSIVE STUFF. FIX THIS BY MAKING THE GRAPH SYMMETRIC.}, and so it is "triangle-free@@dir" (since $H$ is "triangle-free@@undir") by \Cref{fact:triangle-free} but has infinite
  "chromatic number" by \Cref{fact:chromatic-number}. 
