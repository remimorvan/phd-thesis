\section{\AP\label{sec:dichotomy-undecidability}%
...
\decisionproblem{""Connectivity in rational graphs""}{
	An "rational presentation of a directed graph" $\•G$,
...
it reduces by \Cref{lem:reduction-hom} to any problem $\HomAutDec{\marked{\?B}}$ when $\?B$ has "finite duality". In turns, by \Cref{prop:marking-preserves-csp-complexity}, it reduces to
