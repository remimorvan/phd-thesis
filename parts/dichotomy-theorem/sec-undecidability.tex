...
We will first reduce the complement of this problem to $\HomRegAut{\?B}$,
...
\begin{proof}[Proof of \Cref{lemma:regular-unreachability-lowerbound}]
	We reduce "Restricted Membership for Deterministic Reversible Turing Machines",
	which is "RE"-hard by \Cref{lemma:restricted-membership-detrevTM-lowerbound},
