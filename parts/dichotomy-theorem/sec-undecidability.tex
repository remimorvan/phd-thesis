\section{\AP\label{sec:dichotomy-undecidability-hom-homreg}%
	Undecidability of the Homomorphism Problems}


We prove the undecidability of $\HomAutDec{\?B}$ and $\HomRegFinDec{\?B}$
...
\begin{marginfigure}
	...
	\begin{tikzpicture}
		\input{tikz/n-link}
	\end{tikzpicture}
	\caption{\AP\label{fig:n-link}The "$n$-link" $\link{n}$ over the "digraph signature".}
\end{marginfigure}
