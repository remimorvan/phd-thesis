...
\begin{proof}
	...
	\Cref{sec:construction-automatic-presentations} to have an explicit construction of an "rational presentation" for this structure---, and extend it to a
...
\begin{proof}[Proof of \Cref{coro:finite-regular-colourability-undecidable}.]
	Putting \Cref{prop:finite-regular-colourability-as-homreg-pb,prop:finite-colourability-of-connected-graphs} together, we obtain a reduction from
	$\HomRegAutDec{\cliqueOmegaPres}$ to "finite regular colourability@@problem".
	
	\begin{claim}
		$\HomRegAutDec{\cliqueOmegaPres}$ is "RE"-hard.
	\end{claim}
	As for \Cref{coro:lowerbound-homreg}, we prove that
	...
	Moreover, by \Cref{thm:dichotomy-theorem-automatic-structures},
	$\HomRegAutDec{\cliqueOmegaPres}$ is "RE"-hard.
\end{proof}