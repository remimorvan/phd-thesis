...
For $n\in\N$, we define the \AP""$n$-link"" $\intro*\link{n}$ be the "$\sigma$-structure"\sidenote{From \autocite[\S~2]{LaroseLotenTardif2007CharacterisationFOCSP}.} 
...
\begin{proposition}[{\cite[Theorem 4.7]{LaroseLotenTardif2007CharacterisationFOCSP}}]%
	...
	\autocite[Corollary 4]{Atserias2008DigraphColoring}.}%
	%%%
...
\autocite{LaroseLotenTardif2007CharacterisationFOCSP}.}
...
\begin{corollary}
	...
	$\HomFinDec{-}$, and prove in \autocite[Theorem 3.2]{LaroseTesson2009UniversalAlgebraCSP}
	...
	Etessami \autocite[Theorem 3.2]{Etessami1997CountingLogSpace} proved that the problem
	...
	to "Connectivity in Finite Graphs" \autocite{SamiD2015USTCONNLogspace}.
