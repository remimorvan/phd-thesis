...
\AP\label{sec:dichotomy-decidability}
...
\AP\label{sec:uniformly-first-order-definable-hom}
...
\AP\label{sec:hyperedge-consistency-finite}
...
\AP\label{sec:hyperedge-consistency-automatic}
