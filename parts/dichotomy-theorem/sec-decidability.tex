...
\begin{proof}[Proof of \Cref{lemma:finite-duality-uniformly-definable-homomorphisms}]
	...
	$\langle \?A_{a,i}, a' \rangle \centernot{\FOmodels} \unarypred{b_j}(y)$
...
Given a finite "$\sigma$-structure" $\?B$, and an arbitrary\sidenote{Note that in this part, while some results---mostly complexity/decidability ones---require the assumption that the "source structure" is finite, some results do not,
