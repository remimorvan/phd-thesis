...
\begin{proof}
	...
	and so \[\{u \in \Sigma^* \mid \langle \univStructSynchronous{\Sigma},u \rangle \FOmodels \phi^*_b(x)\}\] is "regular@@lang" by \todo{ADDREF}.
...
if $\langle a_1,\, \hdots,\, a_{k-1} \rangle \in \adjacency{a}{\?A}{\+R}{i}$,
then there exists $b_1 \in F(a_1)$, $\hdots$, $b_{k-1} \in F(a_{k-1})$ "st" 
$\langle b_1,\, \hdots,\, b_{k-1} \rangle \in \adjacency{b}{\?B}{\+R}{i}$.\footnote{%
...
\begin{proof}
	...
	$\langle a_1,\, \hdots,\, a_{k-1} \rangle \in \adjacency{a}{\?A}{\+R}{i}$,
	then there exists $b_1 \in F(a_1)$, $\hdots$, $b_{k-1} \in F(a_{k-1})$ "st" 
	$\langle b_1,\, \hdots,\, b_{k-1} \rangle \in \adjacency{b}{\?B}{\+R}{i}$.
	...
	\begin{align*}
		\chi_b(x) \defeq\; &
			...
			\\ 
			& \hspace{2em} \Rightarrow \Big(\bigvee_{\substack{\langle b_1,\hdots,b_{i-1},b_{i+1},\hdots b_k\rangle \in \adjacency{b}{\?B}{\+R}{i}}}\;
...
\begin{proof}
	...
	if $\langle a_1,\, \hdots,\, a_{k-1} \rangle \in \adjacency{h(a)}{\?A}{\+R}{i}$,
	then there exists $b_1 \in F(a_1)$, $\hdots$, $b_{k-1} \in F(a_{k-1})$ "st" 
	$\langle b_1,\, \hdots,\, b_{k-1} \rangle \in \adjacency{b}{\?B}{\+R}{i}$.
	Then let $\+R_{(k)} \in \sigma$ and $i \in \lBrack 1,k\rBrack$.
	Let $\langle a_1,\, \hdots,\, a_{k-1} \rangle \in \adjacency{a}{\?A'}{\+R}{i}$.
	Then $\langle h(a_1),\, \hdots,\, h(a_{k-1}) \rangle \in \adjacency{h(a)}{\?A}{\+R}{i}$
	...
	for every $\+R_{(k)} \in \sigma$, for every $i \in \lBrack 1,k\rBrack$,
	if $\langle a_1,\, \hdots,\, a_{k-1} \rangle \in \adjacency{a}{\?A'}{\+R}{i}$, then
	there exists $b_1 \in F'(a_1)$, $\hdots$, $b_{k-1} \in F'(a_{k-1})$
	"st" $\langle b_1,\, \hdots,\, b_{k-1} \rangle \in \adjacency{b}{\?B}{\+R}{i}$.
...
\begin{proof}
	...
	are elements $\langle a_1,\,\hdots,\,a_{k-1}\rangle \in \adjacency{a}{\?A}{\+R}{i}$
	"st"  
	...
	to keep (for distance $m=1$) only one tuple $\langle a_1,\,\hdots,\,a_{k-1}\rangle \in \adjacency{a}{\?A}{\+R}{i}$. By induction on $m$, we
