...
\begin{abstract}%
	...
	We prove it to be computationally equivalent to the "finite regular colourability of automatic graphs", that takes an "automatic presentation" of a "graph" as input, and asks whether
