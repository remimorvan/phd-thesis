...
\footnote{The related notion of ``regular isomorphism'' was studied in
\cite[Definition~6.10]{KhoussainovNerode1995AutomaticPresentations}.
TODO:talk about this IN INTRO/related work!!!}
...
\begin{example}[{\Cref{ex:dual-P2}, continued}]
	...
	"tree duality".%
	\footnote{We will see in \Cref{sec:hyperedge-consistency-finite}
	...
	\end{marginfigure}
	On the other hand, we saw in \Cref{ex:dual-P2} that $\pathGraph{2}$ does not have
