...
in $\confGraph$, for a given TM $T$. Such a configuration graph is depicted on
\Cref{fig:reduction-wf-RTM-to-colouring-config-graph-wf-RTM}.
...
\begin{figure}[htb]
    ...
    \caption{
        ...
        The "automatic tree@rational graph" $\+T$ of \Cref{ex:tree-not-2-reg-colourable},
