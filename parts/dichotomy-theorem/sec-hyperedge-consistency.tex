...
\begin{example}[{\Cref{example:zigzag-defn}, continued}]
...
As an example, \Cref{example:zigzag-hyperedge-consistency} witnesses that
...
\end{marginfigure}
\begin{example}[{\Cref{example:zigzag-hyperedge-consistency}, continued}]
	...
	are identical to \Cref{example:zigzag-hyperedge-consistency}.
