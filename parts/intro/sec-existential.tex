...
of "first-order logic" where neither universal quantification nor negation is allowed---called
...
\end{marginfigure}
Yet another characterization of these queries is as finite union of "conjunctive queries",
