...
of "first-order logic" where universal quantification, union and negation are not allowed---called
\AP""existential-positive fragment"".
...
To face this issue, "graph databases", also known as knowledge graphs have
...
\end{itemize}
They key feature of query languages for "graph databases" is illustrated
by the \lstinline[language=SQL]{wdt : P31 / wdt : P279 *} instruction:
...
The general question for "tree-width" $k$ is left open at the end
