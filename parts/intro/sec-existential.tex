...
Hence, the central part (ll. 4--6) of the SPARQL query of \Cref{fig:sparql,fig:sparql-explained}
...
\begin{table}
	...
	\caption{Output of the SPARQL query of \Cref{fig:sparql,fig:sparql-explained}.}
\end{table}