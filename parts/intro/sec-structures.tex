...
we will consider more complex structures: 
...
\begin{example}[Graph colouring]
	...
	see "eg" \Cref{fig:dichotomy-ex-3-clique}---if,
...
of a solution to the problem, but in fact the set of "homomorphisms" is in fact
...
and \emph{constraint satisfaction problems}.
% Formally, we define:
% \begin{itemize}
