...
query evaluation to SAT solving---that can all be encoded as
...
to illustrate the flexibility of the homomorphism framework.
...
\begin{example}[Sudoku grids]
	...
	complete Soduku grid that extend $G$, with $f(\tup{i,j})$ giving
