...
to finitely-presentable infinite "structures".
...
or unsatisfiable (false is all models).
...
it shatters the Platonistic idea of an unequivocal \& universal mathematical world, or 
at the very least of one that can be captured by axioms.

Ironically, what makes "Gödel's incompleteness theorem" a proper
abomination---at least for computer scientists---is probably Gödel's own theorem, that he proved only one year before in his
...
you would get an answer! In this strange world, this thesis would probably look very different,
as mathematicians might have had to find a new occupation.%
\footnote{For instance, like Cantor, proving that Jesus is the son of Joseph of Arimathea.}
...
How to deal with this harsh situation?
\begin{marginfigure}
	\centering
	\[
	\contraction{}{\tau\,}{{\vee} {\neg} {\in}}{\!\square}
...
\end{marginfigure}
For mathematicians, denial is perhaps the most common option:
...
we refer them to the formula of \Cref{fig:intro-bourbaki}---which is already a huge improvement on
\Cref{fig:intro-frege}!
...
that is was complete, and hence decidable \todo{addref}.
...
Hence, logic is not completely useless at capturing infinite complex structures.
