...
Whether the seminal results of \cite{CzerwinskiMartensNiewerthParys2018Minimization} could be lifted from "tree patterns" to their encoding as "CRPQs" remains open.
...
\footnote[][-1.5cm]{This contrasts with the fact that "minor-closed classes" are closed under taking "cores".}
