...
(\Cref{prop:minimization-CQ}), we could only hope to be able to capture 
...
\paragraph{Why should we consider such complex objects?}
...
\begin{itemize}
	...
	\item a very partial generalization of "Grohe's theorem" to
		"finite redundant" Boolean "UC2RPQs" (\Cref{thm:tractability-finred}).
\end{itemize}
...
One the negative side, we do not know what to do with this result…
