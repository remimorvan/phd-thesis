...
\begin{chapterpresentation}
	\begin{abstract}
		...
		The algorithm is in "2ExpSpace", but for the restricted but practically relevant case of
		"simple regular expressions", we show that the complexity of the problem drops to "PiP2".
	...
	\begin{acknowledgements}
		...
		Part of the preliminaries and of the introduction have been moved to \Cref{ch:prelim-graph-databases}.
