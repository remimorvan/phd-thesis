...
\begin{proof}
	...
	put in perspective with \cite[Lemma XIII.4.11, p.~229]{pin_mathematical_2022} which proves a similar result in the context of monoids.}
...
\begin{proof}
	We very roughly follow the proof schema of \cite[\S XIII.4, pp.~226--229]{pin_mathematical_2022}---which is
	...
	\[
		\proj{\+R} =
		\phi^{-1}[\Acc] = \cup_{x \in \Acc} \phi^{-1}[x]
	\]
