...
\input{parts/algebra/sec-introduction.tex}
\input{parts/algebra/sec-preliminaries.tex}
\input{parts/algebra/sec-synchronous-algebras.tex}
\input{parts/algebra/sec-lifting-theorem.tex}
\input{parts/algebra/sec-discussion.tex}