...
\input{parts/algebra/sec-introduction}
\input{parts/algebra/sec-preliminaries}
\input{parts/algebra/sec-synchronous-algebras}
\input{parts/algebra/sec-lifting-theorem}
\input{parts/algebra/sec-discussion}

\clearpage
\begin{subappendices}
	\input{parts/algebra/apdx-monads}
	\input{parts/algebra/apdx-pointers}
\end{subappendices}