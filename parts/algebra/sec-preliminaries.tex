...
it follows from Ash's famous type II theorem \cite[Theorem 2.1, p.~129]{Ash1991Inevitable}, see \cite[Theorem 1.1, p.~3]{Henckell1991Ash} for a presentation of the result in terms of pointlike sets, see also \cite[\S III, Theorem 8, p.~5]{PlaceZeitoun2023Group} for an elegant automata-theoretic reformulation.
