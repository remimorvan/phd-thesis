...
undecidable separability problem \cite[Corollary 1.6, p.~478]{Rhode2011Pointlike}.\footnote{The paper cited only claims undecidability of pointlikes, but it was noted in \cite[\S 1, pp.~1--2]{Gool2019Pointlike} that undecidability of the 2-pointlikes also holds, which is a problem 
