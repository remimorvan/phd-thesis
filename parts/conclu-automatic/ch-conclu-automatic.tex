...
\footnote{By ``algebraic characterization'' we formally mean an "Eilenberg-Schützenberger correspondence".}
...
\begin{conjecture}[Projecting algebraic characterization]
	...
	a ``natural function'' from "Eilenberg-Schützenberger correspondences" over $\Monad[T]$
	to "Eilenberg-Schützenberger correspondences" over $\Monad[S]$.
\end{conjecture}
