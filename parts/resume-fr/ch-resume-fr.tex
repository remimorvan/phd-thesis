...
\footnote{En termes techniques, la notion de simplicité se traduit techniquement par « le langage appartient-il à une pseudovariété de langages fixée ».}
...
\begin{contribution}
	...
	avec une « forme simple »---, alors on peut toujours décider si un automate synchrone est équivalent à un autre automate synchrone de « forme simple ».
\end{contribution}
