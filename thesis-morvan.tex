...
% \linenumbers
% \renewrobustcmd{\todo}[1]{\textcolor{red}{todo: #1}}
...
\frontmatter
\includepdf[pages={1}]{parts/frontcover.pdf}
...
\mainmatter
{
	...
	\include{parts/resume-fr/ch-resume-fr}
}
...
\include{parts/semantic-tw/ch-semantic-tree-width-CRPQ}
\include{parts/conclu-databases/ch-conclu-databases}

\include{parts/entracte}
