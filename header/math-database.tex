...
\newrobustcmd{\A}{\symbb{A}} % Finite alphabet of labels
\newrobustcmd{\B}{\symbb{B}}
\knowledgenewrobustcmd{\Aext}{\cmdkl{\symbb{A}^\pm}} % Finite alphabet of labels
...
\knowledgenewrobustcmd{\alphabetmarking}{\cmdkl{\symbb{M}}}
