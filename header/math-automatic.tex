...
\knowledgenewrobustcmd{\relPres}[2]{\cmdkl{#1}_{\! #2}}
...
\knowledgenewrobustcmd{\FederVardi}[1]{\cmdkl{\mathfrak{U}(#1)}} % Feder-Vardi's construction
\knowledgenewrobustcmd\Myc{\mathop{\cmdkl{\mathfrak{M}}}} % Mycielski's construction
