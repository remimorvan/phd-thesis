...
\newrobustcmd{\nothomregto}{\mathrel{\kl[\homregto]{\cancel{\smashxrightarrow{reg hom}}}}}
...
\knowledgenewrobustcmd{\DRAT}{\cmdkl{\ensuremath{\textsc{DRat}}}}%
...
\knowledgenewrobustcmd\bigdisunion{%
...
\newcommand{\asympbar}{\raisebox{-.1em}{\scalebox{.6}{\ensuremath{\setstackgap{S}{0pt}%
	\stackMath\mathrel{\stackon{\frown}{\stackon{\raisebox{.135em}{\rule{.6em}{.08em}}}{\smile}}}}}}}
% \newcommand{\notasympbar}{\raisebox{-.1em}{\scalebox{.6}{\ensuremath{\setstackgap{S}{0pt}%
% 	\stackMath\mathrel{\stackon{\frown}{\stackon{\raisebox{.135em}{\rule{.6em}{.08em}}}{\smile}}}}}}}
...
\newrobustcmd\notcongr[1]{%
	\mathrel{\kl[\congr]{\cancel{\asympbar}_{#1}}}%
}
...
\knowledgenewrobustcmd\NilS{\cmdkl{\symbb{N}\textrm{il}}}
\knowledgenewrobustcmd\LocTriv{\cmdkl{\+{L\mkern-1mu I}}}
\knowledgenewrobustcmd\LocTrivS{\cmdkl{\symbb{LI}}}
...
% Free pro-V algebras
\knowledgenewrobustcmd\distvar[1][\symbb{V}]{%
	\mathop{\cmdkl{\textbf{d}}_{#1}}%
}
\knowledgenewrobustcmd\ristvar[1][\symbb{V}]{%
	\mathop{\cmdkl{\textbf{r}}_{#1}}%
}
\knowledgenewrobustcmd\simvar[1][\symbb{V}]{\mathrel{\cmdkl{\asympbar_{#1}}}}
\knowledgenewrobustcmd\freepro[2][\symbb{V}]{\cmdkl{\smash{\widehat{\mathbf{F}}}_{#1}#2}}
\knowledgenewrobustcmd\freeproproj[1][\symbb{V}]{\cmdkl{\pi_{#1}}}

\newrobustcmd\Pl[1][\symbb{V}]{%
	\mathop{%
		\withkl{\kl[\Pl]}{%
...
\knowledgenewrobustcmd\MonadSync[1][2]{\cmdkl{\?{S}_{#1}}}
\knowledgenewrobustcmd\MonadSyncP[1][2]{\cmdkl{\?{S}^+_{#1}}}
...
\newrobustcmd\Monad[1][T]{\mathbf{#1}}
\newrobustcmd{\unit}[1][]{\textnormal{\textrm{unit}}_{#1}}
\newrobustcmd{\mult}[1][]{\textnormal{\textrm{mult}}_{#1}}

\knowledgenewrobustcmd\MF[2]{\cmdkl{{#1}_{#2}}} % Monad functor
\knowledgenewrobustcmd\MFunit{\cmdkl{\textsc{(mf)}$_{\textrm{unit}}$}} % Monad functor axiom
\knowledgenewrobustcmd\MFmult{\cmdkl{\textsc{(mf)}$_{\textrm{mult}}$}}

\knowledgenewrobustcmd\MonadPlus{\cmdkl{\mathbf{K}^{\boldsymbol{+}}}}
\knowledgenewrobustcmd\omegafin{\cmdkl{\omega\textsf{-up}}}
\knowledgenewrobustcmd\MonadWilke{\cmdkl{\mathbf{W}}}
\newrobustcmd\projMon{%
	\mathop{%
		\withkl{\kl[\projMon]}{%
			\cmdkl{\mathrm{proj}}
...
\knowledge{\zero}{notion}
\knowledgenewrobustcmd\MFproj{\cmdkl{\MF{\Phi}{\projMon}}}
\knowledgenewrobustcmd\MFzero{\cmdkl{\MF{\Psi}{\zero}}}