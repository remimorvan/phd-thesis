...
\knowledgenewrobustcmd\Monad[1][T]{\cmdkl{\mathbf{#1}}}
\knowledgenewrobustcmd\monad[1][T]{\cmdkl{#1}}
\knowledgenewrobustcmd{\unit}[1][]{\cmdkl{\textnormal{\textrm{unit}}_{#1}}}
\knowledgenewrobustcmd{\mult}[1][]{\cmdkl{\textnormal{\textrm{mult}}_{#1}}}
...
\knowledgenewrobustcmd\omegafin{\cmdkl{\mathfrak{fin}\text{-}\omega}}
...
\knowledgenewrobustcmd\MFproj{\cmdkl{\MF{\Phi}{\proj}}}
