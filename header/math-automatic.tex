...
%%%%%%
\knowledgenewrobustcmd{\REC}{\cmdkl{\textsc{Rec}}}%
\knowledgenewrobustcmd\kREC[1][k]{\cmdkl{#1\textsc{-Rec}}}
\knowledgenewrobustcmd\kPROD[1][k]{\cmdkl{#1\textsc{-Prod}}}

% ---
% Separation to Colourability
% ---
\knowledgenewrobustcmd{\Init}{\cmdkl{\textrm{Init}}}
\newrobustcmd{\InitC}[1]{\kl[\Init]{\color{#1}\textrm{Init}}} % variant with color
\knowledgenewrobustcmd{\Reach}{\cmdkl{\textrm{Reach}}}
\newrobustcmd{\ReachC}[1]{\kl[\Reach]{\color{#1}\textrm{Reach}}} % variant with color

\knowledgenewrobustcmd{\incompGraph}[2]{\cmdkl{\+{Inc}_{#1,#2}}} % incompatibility graph
...
\knowledgenewrobustcmd{\Id}{\cmdkl{\mathit{Id}}} % identity relation

\knowledgenewrobustcmd{\AutGraph}[2]{\cmdkl{\langle#1,#2\rangle}}%
\knowledgenewrobustcmd{\configs}[1][T]{\cmdkl{\textit{Confs}_{#1}}}
\knowledgenewrobustcmd{\confGraph}[1][T]{\cmdkl{{\+G}^{#1}}}

\knowledgenewrobustcmd{\autequiv}[1][R]{\cmdkl{\sim_{#1}}} % todo:wtf is this?
\knowledgenewrobustcmd{\lotimes}[1]{\cmdkl{\otimes}#1} % todo:wtf is this?